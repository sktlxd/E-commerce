        ...
        <Provider store={store}>
          ...
          <Content>
            <Layout style={{ padding: '0 0', background: '#fff' }}>
              ...
              <Content style={{ padding: '0 24px', minHeight: 'calc(100vh)',background: '#F8F8FF' }}>
                <Switch>
                  <Route exact path={'/app'} component={ (props) => <Index { ...props }/> } />
                  { routers.map(item => item.routerDom) }
                  {/* 产品 */}
                  <Route path={'/app/addNewProducts'} exact component={(props) => <AddNewProducts {...props} />} />
                  <Route path={'/app/addNewProductSeries'} exact component={(props) => <AddNewproductSeries {...props} />} />
                  <Route path={'/app/addNewClients'} exact component={(props) => <AddNewClients {...props} />} />
