...
class SaleOrder extends Component {
    ...
    state = {
        columns: [
            { title: '订单单号', dataIndex: 'order_code', align: 'center', width: '10%' },
            ...
            { title: '总计', dataIndex: 'order_total_price', align: 'center', width: '15%' },
            {
              ...
              render: (text, record) => {
                  return (
                    <Button type='primary' size='small' onClick={() => history.push(`#`)}>查看订单</Button>
                  )
              }
            }
        ],
                ...
                <div className='func'>
                    <div className='clearfix'>
                        <div style={{ float: 'left', marginLeft: '20px' }} >
                            <Input name='searchOrderCode' value={searchOrderCode} placeholder='订单编号' allowClear onChange={e => this.onChange(e.target.value, 'searchOrderCode')} />
                        </div>
